...
void UpdateCameraCustom(Camera* camera)
{
    ...
    if (IsKeyDown(KEY_RIGHT) || IsGamepadButtonDown(0, GPICASE_TRIGGER_LEFT)) cameraAngle.x += (1.0f * DEG2RAD);      // GAMEPAD_BUTTON_LEFT_TRIGGER_1    // GAMEPAD_BUTTON_LEFT_FACE_LEFT    // DPAD LEFT
    if (IsKeyDown(KEY_LEFT) || IsGamepadButtonDown(0, GPICASE_TRIGGER_RIGHT)) cameraAngle.x -= (1.0f * DEG2RAD);     // GAMEPAD_BUTTON_RIGHT_TRIGGER_1   // GAMEPAD_BUTTON_LEFT_FACE_RIGHT   // DPAD RIGHT
    // lembrar de implementar camera cima e baixo
