...
// //------------------------------------------------------
// // 1. STRUCT **antes** das fun��es ? corrige o warning
// //------------------------------------------------------
...
// //------------------------------------------------------
// // 2. Fun��o do libcurl para armazenar o texto recebido
// //------------------------------------------------------
...
//         "Voc� � um jogador profissional de UNO.\n"
//         "A carta atual da mesa �: Cor = %s, Valor = %s.\n"
//         "Aqui est�o minhas cartas:\n%s\n"
//         "Aqui est�o o n�mero de cartas do proximo jogador:\n%d\n"
...
//         "Caso queira jogar incolor, SEMPRE escolha a cor que mais tem na sua m�o\n"
//         "Responda APENAS e EXCLUSIVAMENTE com o n�mero da carta (1, 2, 3...).\n"
//         "Caso n�o tenha nenhuma carta v�lida SEMPRE ESPONDA com o n�mero 0",
//         corCarta(cartaTopo),
...
//     // 4. Converter texto para n�mero
//     int escolha = atoi(resposta);

//     free(resposta);

//     return escolha;  // 0 = n�o jogar nada
// }
...
//             return i; // devolve jogada v�lida
//         temp = temp->next;
//         i++;
//     }
